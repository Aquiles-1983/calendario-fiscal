...
<style>{`@import url('https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap'); *{box-sizing:border-box;margin:0;padding:0} ::-webkit-scrollbar{width:5px;height:5px} ::-webkit-scrollbar-track{background:#F0F4FA} ::-webkit-scrollbar-thumb{background:${SE.blue};border-radius:3px} .pip{cursor:pointer;transition:opacity .15s,transform .15s} .pip:hover{opacity:.78;transform:scale(1.06)} .th-s{cursor:pointer;user-select:none;transition:background .15s} .th-s:hover{background:${SE.blueDk}!important} select:focus,input:focus{outline:2px solid ${SE.blueLt}} tr.row:hover td{background:#EBF2FF!important}`}</style>
